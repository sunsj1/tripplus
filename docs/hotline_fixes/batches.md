...
**Acceptance**
- [x] Evaluate-on-tick + shared notification instance + deep-link tap → Trip / history (lock-screen tray still A7)
- [x] Notification tap opens Trip / history
- [x] Single notification plugin instance; no double-init races
...
**Acceptance**
- [x] Fatigue cannot be skipped solely because the 30s poll missed minutes 180–185
- [x] Second fuel alert after 20 min appears in history
- [x] All alert scenario tests green
...
**Acceptance**
- [x] During active trip, driving past a pump removes it from the fuel list without leaving/re-entering the screen
- [x] Behind-corridor items never shown as “ahead” when GPS is fresh
- [x] Without GPS, UI explains degraded mode (full corridor or waiting) — no silent wrong list
...
**Acceptance**
- [x] Denied permissions never look like “app is fine but quiet”
- [x] Stale GPS surfaces a visible degraded state
...
*Created: 2026-07-18 · Next up: **Batch A7** (device QA — `HA-070`…).*
